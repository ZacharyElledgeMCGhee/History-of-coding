...
// countNodes will return an 
// integer indicating the number
// of nodes currently in the tree
template <typename T>
...
// height will return the height
// of the tree (greatest node depth)
...
// kthValue will accept an integer parameter
// "k" and return the kth smallest value in the tree
template <typename T>
